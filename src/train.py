"""train.py - Training script with Albumentations augmentation, 10% val split,
loss plotting and fixed evaluation losses."""
...
def main(cfg):
    ...
    ckpt_path = out_dir / 'best_model_v2.pth'
...
def parse_args():
    ...
    parser.add_argument('--outdir', default='runs/albu_exp')
